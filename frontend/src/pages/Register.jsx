...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // AppContext register() will handle navigation to onboarding
    } catch (err) {
      const message = err?.response?.status === 404
        ? 'Registration endpoint was not found. Restart the backend server and try again.'
    ...
    <div className="login-page-wrapper">
      ...
      <div className="layout">
        ...
        <div className="card">
          ...
          <h1 style={{ fontSize: '24px', marginBottom: '8px', position: 'relative' }}>Create Account <span className="sp" style={{top: '-2px', right: '-20px'}}>✦</span></h1>
          <p className="subtitle">
            Start your <span className="ac">adaptive learning journey</span><br/>
            with your <span className="str">personalized AI Coach.</span>
          </p>

          <form onSubmit={handleRegister} className="ig-form">
            <div className="ig">
            ...
            <button type="submit" className="btn-cta" style={{marginTop: '10px'}}>Register <span style={{fontSize: '16px'}}>→</span></button>
          </form>
